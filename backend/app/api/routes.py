...
def get_run(run_id: str, db: Session = Depends(get_db)):
    ...
    return RunDetailOut(
        ...
        brand_first_mention_position=run.brand_first_mention_position,
        brand_mention_density=run.brand_mention_density,
        brand_prominence_score=run.brand_prominence_score,
        citation_quality_score=run.citation_quality_score,
        first_citation_position=run.first_citation_position,
        citation_rate_observed=run.citation_rate_observed,
        citation_rate_corrected=run.citation_rate_corrected,
        competitor_mention_ratio=run.competitor_mention_ratio,
        share_of_voice_llm=run.share_of_voice_llm,
        cocitation_competitors=run.cocitation_competitors,
        conversational_trigger_count=run.conversational_trigger_count,
        engagement_score=run.engagement_score,
        zero_click_presence=run.zero_click_presence,
        ...
        conversion_potential_score=run.conversion_potential_score,
    )
