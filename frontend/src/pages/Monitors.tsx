...
const ENGINE_PRESETS: EnginePreset[] = [
  ...
  { name: 'openai', region: 'BR', device: 'desktop', config_json: { model: 'gpt-5' }, label: 'OpenAI GPT-5 (Desktop)' },
  { name: 'openai', region: 'BR', device: 'mobile', config_json: { model: 'gpt-5' }, label: 'OpenAI GPT-5 (Mobile)' },
  { name: 'openai', region: 'BR', device: 'desktop', config_json: { model: 'gpt-5-mini' }, label: 'OpenAI GPT-5 mini (Desktop)' },
  { name: 'openai', region: 'BR', device: 'mobile', config_json: { model: 'gpt-5-mini' }, label: 'OpenAI GPT-5 mini (Mobile)' },
