...
const ENGINE_PRESETS: EnginePreset[] = [
  { name: 'gemini', region: 'BR', device: 'desktop', config_json: { model: 'gemini-2.5-pro', web_search: true, search_context_size: 'medium' }, label: 'Gemini 2.5 Pro (Desktop)' },
  { name: 'gemini', region: 'BR', device: 'mobile', config_json: { model: 'gemini-2.5-pro', web_search: true, search_context_size: 'medium' }, label: 'Gemini 2.5 Pro (Mobile)' },
  { name: 'gemini', region: 'BR', device: 'desktop', config_json: { model: 'gemini-2.5-flash', web_search: true, search_context_size: 'medium' }, label: 'Gemini 2.5 Flash (Desktop)' },
  { name: 'gemini', region: 'BR', device: 'mobile', config_json: { model: 'gemini-2.5-flash', web_search: true, search_context_size: 'medium' }, label: 'Gemini 2.5 Flash (Mobile)' },
  { name: 'openai', region: 'BR', device: 'desktop', config_json: { model: 'gpt-4o', web_search: true, search_context_size: 'medium' }, label: 'GPT-4o (Desktop)' },
  { name: 'openai', region: 'BR', device: 'mobile', config_json: { model: 'gpt-4o', web_search: true, search_context_size: 'medium' }, label: 'GPT-4o (Mobile)' },
  { name: 'openai', region: 'BR', device: 'desktop', config_json: { model: 'gpt-4o-mini', web_search: true, search_context_size: 'medium' }, label: 'GPT-4o mini (Desktop)' },
  { name: 'openai', region: 'BR', device: 'mobile', config_json: { model: 'gpt-4o-mini', web_search: true, search_context_size: 'medium' }, label: 'GPT-4o mini (Mobile)' },
  { name: 'openai', region: 'BR', device: 'desktop', config_json: { model: 'gpt-5', web_search: true, search_context_size: 'medium' }, label: 'OpenAI GPT-5 (Desktop)' },
  { name: 'openai', region: 'BR', device: 'mobile', config_json: { model: 'gpt-5', web_search: true, search_context_size: 'medium' }, label: 'OpenAI GPT-5 (Mobile)' },
  { name: 'openai', region: 'BR', device: 'desktop', config_json: { model: 'gpt-5-mini', web_search: true, search_context_size: 'medium' }, label: 'OpenAI GPT-5 mini (Desktop)' },
  { name: 'openai', region: 'BR', device: 'mobile', config_json: { model: 'gpt-5-mini', web_search: true, search_context_size: 'medium' }, label: 'OpenAI GPT-5 mini (Mobile)' },
  { name: 'perplexity', region: 'BR', device: 'desktop', config_json: { model: 'sonar-pro', web_search: true, search_context_size: 'medium' }, label: 'Perplexity Sonar (Desktop)' },
